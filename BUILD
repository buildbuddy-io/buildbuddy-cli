...
# gazelle:resolve go github.com/buildbuddy-io/buildbuddy/proto/publish_build_event @com_github_buildbuddy_io_buildbuddy//proto:publish_build_event_go_proto
...
alias(
    name = "tsconfig.json",
    actual = "@com_github_buildbuddy_io_buildbuddy//:tsconfig.json",
)
